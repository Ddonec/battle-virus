         ...
         <div className="game-start-container rules-update">
            ...
            <div className="welocme-white-container rules-white">
               ...
               <div className="welcome-subtitle black-text rules">
                  <p>
                     <div className="number-list">1</div>Ваши помощники в игре — лекарственные средства. Расположите их в своей зоне самостоятельно или воспользуйтесь кнопкой «Случайная расстановка».
                     Вы можете менять положение лекарственных средств бесконечное количество раз.
                  </p>
                  <p>
