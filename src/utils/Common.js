...
export function getSetupShips() {
   return [
      [
         { id: 6, x: -1, y: -1, w: 0, h: 0, health: 1, bg: "1" },
         { id: 7, x: -1, y: -1, w: 0, h: 0, health: 1, bg: "2" },
         { id: 8, x: -1, y: -1, w: 0, h: 0, health: 1, bg: "3" },
         { id: 9, x: -1, y: -1, w: 0, h: 0, health: 1, bg: "4" },
      ],
      [
         { id: 3, x: -1, y: -1, w: 1, h: 0, health: 2, bg: "5" },
         { id: 4, x: -1, y: -1, w: 1, h: 0, health: 2, bg: "6" },
         { id: 5, x: -1, y: -1, w: 1, h: 0, health: 2, bg: "7" },
      ],
      [
         { id: 1, x: -1, y: -1, w: 2, h: 0, health: 3, bg: "8" },
